module.exports = {
    translation : {
        ...
        'EXIT_MESSAGE': [
            ...
            'I\'m sad to see you go. Come back again soon. %s',
            'Your wish is my command, arrivederci. %s',
            'Your wish is my command, bye. Come back soon. %s',
            'Your wish is my command, bye. %s',
            'Thank you for playing Don\'t Wake the Monster, bon voyage my friend. %s',
            'Gone so soon? I hope you play Don\'t Wake the Monster soon. Bye %s'
        ],
        ...
        'PLAYER_CONFIRMATION': [
            ...
            'Roger that, player %s. You are the %s. Your color will be %s.',
            'Good choice player %s. You are the %s. Your color will be %s.',
            'Player %s, I like the way you think. You are the awesome %s. Your color will be %s.'
        ],
        ...
        'GAME_INSTRUCTIONS_START': 'Player 1, AKA the %s, what would you like to do?',
        ...
        'BEAN_TOTAL_SUCCESS':[
            'For a total of %s magical %s.',
            'So far you have %s magical %s.'
        ],
        'BEAN_TOTAL_FAIL':[
            'You have a total of %s magical %s.',
            'So far your total consists %s magical %s.',
            'That makes a total of %s magical %s.'
        ],
